...
The C2 host is raven0 ([raven0 C2 setup](#raven0-c2-setup)), each of the others is raven*n* ([remote raven setup](#remote-raven-setup)). Each remote needs to be added to the target network, which is an acknowledged shortcut of the initial attack vectors, e.g. phishing attack. This is for two reasons:
